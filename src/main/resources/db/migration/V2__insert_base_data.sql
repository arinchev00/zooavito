...
-- ==================== ВСТАВКА АДМИНА ====================
INSERT INTO users (full_name, email, telephone_number, password)
SELECT 'Admin', 'admin123@admin.com', '+7(999)123-45-67', '$2a$11$vQuPLtwJy2UzNEVhQPFPh.prNNy5vhqXpYxelshR/Jaz8Tn7iMDNq'
